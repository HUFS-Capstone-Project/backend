...
class DateCourseUpdateRequestValidationTest {
	...
	@Test
	void courseNameBlankViolatesConstraint() {
	...
	@Test
	void courseNameExceeds20CharsViolatesConstraint() {
	...
	@Test
	void courseNameIsTrimmedOnConstruction() {
	...
	@Test
	void roomPlaceIdsEmptyViolatesConstraint() {
	...
	@Test
	void roomPlaceIdsWithSingleElementPassesConstraint() {
